...
api_router.include_router(memory_router, tags=["Personalization and Long-Term Memory"])
api_router.include_router(agent_router, tags=["AI Agent Framework & Tool Calling"])
